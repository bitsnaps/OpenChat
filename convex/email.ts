    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="output">
                ...
                <div class="button-container">
                    <a href="${process.env.SITE_URL || "https://oschat.ai"}/c/${chatId}" class="cli-button">
                        open dashboard
                    </a>
                </div>
        ...
        <div class="footer">
            ...
            <div class="footer-line">
                ...
                <a href="${process.env.SITE_URL || "https://oschat.ai"}/settings" class="footer-link">account_settings</a>
            </div>
        </div>
    </div>
</body>
...
//                 <a href="${process.env.SITE_URL || 'https://oschat.ai'}/chat/${chatId}" class="cta-button">
//                     View Full Results
//                 </a>
//             </div>
//         </div>
...
//             <p class="footer-text">You can manage your notification preferences in your <a href="${process.env.SITE_URL || 'https://oschat.ai'}/settings" class="footer-link">account settings</a>.</p>
//         </div>
//     </div>
// </body>
// </html>`;
...
View full results: ${process.env.SITE_URL || "https://oschat.ai"}/chat/${chatId}
