		...
		<div className="space-y-8">
			...
			<header className="space-y-4">
				...
				<p className="text-muted-foreground leading-relaxed">
					Personalize how {APP_NAME} interacts with you. Set your preferences
				...
				<div className="space-y-2">
					...
					<div className="flex min-h-10 flex-wrap items-center gap-1.5 rounded-md border bg-background px-3 py-2 focus-within:ring-1 focus-within:ring-ring">
						...
						<input
							...
							placeholder={
								traits.length === 0 ? "Type a trait and press Enter…" : ""
							}
							type="text"
							value={traitInput}
						/>
					...
					{Boolean(
						defaultTraits.filter((trait) => !traits.includes(trait)).length > 0
					) && (
