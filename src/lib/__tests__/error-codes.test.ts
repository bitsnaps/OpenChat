...
describe("ERROR_CODES", () => {
	...
	it("includes all business error codes", () => {
		expect(ERROR_CODES.PREMIUM_MODEL_ACCESS_DENIED).toBe(
			"PREMIUM_MODEL_ACCESS_DENIED"
		);
	...
	it("includes all streaming error codes", () => {
		expect(ERROR_CODES.PROVIDER_STREAM_RATE_LIMIT).toBe(
		...
		expect(ERROR_CODES.PROVIDER_STREAM_AUTH_ERROR).toBe(
