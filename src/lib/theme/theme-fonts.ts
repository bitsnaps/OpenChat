...
export function getCurrentFontSelection(
...
// Check if a theme is using default/system fonts
export function isUsingSystemFonts(themeStyles: Partial<ThemeStyleProps>): boolean {
