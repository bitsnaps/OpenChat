...
export const PASTE_ALLOWED_MIME: readonly UploadAllowedMime[] = UPLOAD_ALLOWED_MIME.filter((t) =>
  t.startsWith("image/"),
);
...
export function getAllowedLabel(mimes: readonly string[] = UPLOAD_ALLOWED_MIME): string {
