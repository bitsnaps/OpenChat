...
export const CONNECTOR_CONFIGS: Record<ConnectorType, ConnectorConfig> = {
	...
	googlecalendar: {
		...
		authConfigId:
			process.env.VITE_CALENDAR_AUTH_CONFIG_ID ?? "googlecalendar_oauth",
	},
	googledrive: {
		type: "googledrive",
		...
		authConfigId:
			process.env.VITE_GOOGLE_DRIVE_AUTH_CONFIG_ID ?? "googledrive_oauth",
	},
	notion: {
		type: "notion",
		displayName: "Notion",
	...
	googledocs: {
		...
		authConfigId:
			process.env.VITE_GOOGLE_DOCS_AUTH_CONFIG_ID ?? "googledocs_oauth",
	},
	googlesheets: {
		type: "googlesheets",
		...
		authConfigId:
			process.env.VITE_GOOGLE_SHEETS_AUTH_CONFIG_ID ?? "googlesheets_oauth",
	},
	slack: {
		type: "slack",
		displayName: "Slack",
