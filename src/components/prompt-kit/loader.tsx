...
function DotsLoader({
	...
	return (
		<div className={cn("inline-flex", gapSizes[size], className)}>
			<span
				className={cn(
					"rounded-full bg-primary animate-[loading-dots_1.4s_infinite_0.2s]",
					dotSizes[size],
				)}
			/>
			<span
				className={cn(
					"rounded-full bg-primary animate-[loading-dots_1.4s_infinite_0.4s]",
					dotSizes[size],
				)}
			/>
			<span
				className={cn(
					"rounded-full bg-primary animate-[loading-dots_1.4s_infinite_0.6s]",
					dotSizes[size],
				)}
			/>
		</div>
